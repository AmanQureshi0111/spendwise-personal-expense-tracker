...
import { HelpCircle, Home, ArrowUp, ArrowDown, User, LogOut, X, Menu } from 'lucide-react';
            ...
            <div className={sidebarStyles.sidebarInner.base}>
                    ...
                    <div className="flex items-center">
                        ...
                        {!isCollapsed && (
                            <motion.div 
                                ...
                                exit={{ opacity: 0, x: -10 }}
                                >
                                    <h2 className="text-sm font-bold text-grey-800 truncate">{username}</h2>
                ...
                <div className={cn(
                    ...
                    <Link
                        ...
                        to="https://www.linkedin.com/in/aman-qureshi-ab7811253/"
                    >
                    ...
                    >
                        <LogOut
                            size={20} className="text-grey-500" 
                        />
                    ...
                    <div className="relative h-full flex flex-col">
                        <div className={sidebarStyles.mobileHeader}>
                            <div className={sidebarStyles.mobileUserContainer}>
                                ...
                                <div>
                                    <h2 className="text-lg font-bold text-grey-800">{username}</h2>
