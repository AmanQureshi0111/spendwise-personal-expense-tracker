...
const Dashboard = () => {
    ...
    // function to check if a date within the range
        ...
        <div className={dashboardStyles.container}>
            <div className={dashboardStyles.headerContainer}>
                        ...
                        additionalContent={
                            <div className="mt-2 text-xs text-cyan-600 flex items-center gap-2">
                                ...
                                {typeof overviewMeta.savingsRate === "number" && (
                                    <span
                                        className={`px-2 py-1 rounder-full text-xs font-medium ${overviewMeta.savingsRate < 0
                ...
                <div className={dashboardStyles.gaugeGrid}>
                    {gaugeData.map((gauge) => (
                        <GaugeCard key={gauge.name} gauge={gauge}
